...
#    def game_data_extractor
        ...
        title_str = ""
        q_set.each do |q|
            title_str = title_str.concat(Attributes_Titles[q]).concat('","') 
        end
        ...
        title_str = title_str.concat('"').concat(Attributes_Titles[q]).concat('"').concat(",") 
        
        
        CSV.open(filename_out,"w") do |csv|
        csv << ["#{title_str}"]
            p_set.each do |p|
                p_str = "#{Problems[p]},"
                idata.each do |stat|
...
# TODO: Figure out where game_data_extractor_2.rb:121: warning: block supersedes default value argument
# game_data_extractor_2.rb:121: warning: block supersedes default value argument
# game_data_extractor_2.rb:121: warning: block supersedes default value argument
# game_data_extractor_2.rb:121: warning: block supersedes default value argument
